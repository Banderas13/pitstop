            ...
            <div class="max-w-7xl mx-auto px-6 lg:px-8">
                <div class="text-center mb-20">
                    ...
                    <p class="text-xl lg:text-2xl text-gray-300 font-light tracking-wide">
                        Beheer je cases en maak nieuwe service aanvragen aan
                    </p>
                    <div class="w-32 h-1 bg-white mx-auto mt-8"></div>
                </div>
                <div class="text-center">
                    <a href="{{ route('service.create') }}" class="bg-pblue hover:bg-white text-black px-8 py-4 rounded font-bold uppercase tracking-wider text-sm transition-colors duration-300">
                    ...
                    <div class="tab-pane active" id="open-cases">
                                    ...
                                    <div class="flex flex-col md:flex-row md:items-center p-4 md:p-8 border-b border-gray-800 last:border-b-0 hover:bg-gray-800/30 transition-colors duration-300 gap-4">
                                        <div class="flex-grow-1 md:ml-6">
                                            <div class="flex flex-col md:flex-row md:items-center mb-3 gap-2">
                                                <h6 class="text-lg font-semibold text-white">Case #{{ $case->id }} - {{ $case->user->name }}</h6>
                        ...
                        @else
                            <div class="text-center py-20">
                                ...
                                <p class="text-gray-400 text-lg mb-4">Je hebt momenteel geen openstaande cases.</p>
                                <a href="{{ route('service.create') }}" class="bg-pblue hover:bg-white text-black px-6 py-3 rounded font-medium uppercase tracking-wider text-sm transition-colors duration-300">
                                    <svg class="w-4 h-4 inline mr-2" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z"/>
                                    </svg>
                                    Maak je eerste case
                    ...
                    <div class="tab-pane" id="closed-cases">
                        ...
                        @else
                            <div class="text-center py-20">
                                ...
                                <p class="text-gray-400 text-lg">Je hebt nog geen cases afgehandeld.</p>
                            </div>
                        @endif
                    </div>
                </div>
