...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-4">
        <div>
            <h2 class="display-6 fw-bold text-dark">Mijn Service Cases</h2>
            <p class="text-muted mb-0">Overzicht van je service aanvragen en reparaties</p>
        </div>
    </div>
        ...
        <div class="tab-pane fade show active" id="open-cases" role="tabpanel">
                            ...
                            <div class="d-flex align-items-center p-4 border-bottom">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <div class="d-flex align-items-center mb-1">
                                        <h6 class="mb-0 me-2">Case #{{ $case->id }}</h6>
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <p class="text-muted mb-4">Je hebt momenteel geen openstaande service cases.</p>
                </div>
            @endif
        </div>
        ...
        <div class="tab-pane fade" id="closed-cases" role="tabpanel">
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">Je hebt nog geen afgehandelde service cases.</p>
                </div>
            @endif
        </div>
    </div>
